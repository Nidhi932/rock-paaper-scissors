...
function saveScores() {
  ...
  localStorage.setItem('rps_comp', compScore);
}
...
function play(userChoice) {
  ...
  let result, resultSub;
  let userWon = false, tie = false;

  if (userChoice === pcChoice) {
    result = 'TIE UP';
    resultSub = '';
    tie = true;
  } else if (beats[userChoice] === pcChoice) {
    result = 'YOU WIN';
    resultSub = 'Against PC';
    userScore++;
    userWon = true;
  } else {
    result = 'YOU LOST';
...
console.log(emojis[pcChoice]);
  ...
  document.getElementById('result-subtext').textContent = resultSub;

  const userRing = document.getElementById('user-ring');
  const pcRing   = document.getElementById('pc-ring');
  userRing.style.display = 'none';
  pcRing.style.display   = 'none';
  document.getElementById('user-circle').classList.remove('winner');
  document.getElementById('pc-circle').classList.remove('winner');
  const nextBtn = document.querySelector('.next-btn')

  
  if (userWon) {
    document.getElementById('user-circle').classList.add('winner');
    userRing.style.display = 'block';
    nextBtn.style.display='block';
  } else if (!tie) {
    document.getElementById('pc-circle').classList.add('winner');
    pcRing.style.display = 'block';
  }
...
function showScreen(screen) {
  ...
  document.getElementById('hurray-screen').style.display = 'none';
